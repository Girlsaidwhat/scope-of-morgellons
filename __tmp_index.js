...
const PAGE_SIZE = 24;
// Cache-bust marker for a fresh JS chunk + visible build badge
const INDEX_BUILD = "idx-36.901";
...
/* duplicate removed: */ function HomePage_DUPE_IGNORE() {
  const router = useRouter();
  ...
  return (
    ...
    >
      ...
      <div aria-hidden="true" style={{ textAlign: "right", marginBottom: 6 }}>
        <span data-build-badge style={{ fontSize: 11, opacity: 0.75, border: "1px solid #e5e7eb", padding: "2px 6px", borderRadius: 6 }}>
          BUILD {INDEX_BUILD}
        </span>
      </div>
      ...
      {/* Global kill-switch to hide any stuck /fill_in_your_story*.jpg images */}
      <style jsx global>{`
        /* Build marker visible on page */
        [data-build-badge] { user-select: none; }
        ...
        /* Hard-disable any stuck story images anywhere on this page */
        img[src*="fill_in_your_story.jpg"],
        img[src*="film_noir_fill_in_your_story.jpg"] {
